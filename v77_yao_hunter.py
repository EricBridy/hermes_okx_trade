...
STATE_FILE = os.path.join(SCRIPT_DIR, "v77_state.json")
LOG_FILE = os.path.join(SCRIPT_DIR, "v77_trades.log")
CHAIN_CACHE_FILE = os.path.join(SCRIPT_DIR, "v77_chain_cache.json")
